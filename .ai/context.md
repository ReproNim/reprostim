...
- **VideoCapture**: Magewell USB device capture with configuration support (see [reprostim-capture/videocapture-spec.md](reprostim-capture/videocapture-spec.md), [reprostim-capture/videocapture-tasks.md](reprostim-capture/videocapture-tasks.md) — currently covers only the `--usb-scan-mode` poll/hotplug feature)
