...
enum {
    ...
    SET_SDI_ANC_TYPE_NUM,
    GET_SDI_ANC_PACKET_NUM,
	...
	VIDEO_ECO_GET_V4L2_DEI_MODE_NUM,
	VIDEO_ECO_SET_V4L2_DEI_MODE_NUM,

    //zero copy capture
    VIDEO_ECO_OCOPY_CAPTURE_OPEN_NUM,
    VIDEO_ECO_OCOPY_CAPTURE_FRAME_PUT_NUM,
    VIDEO_ECO_OCOPY_CAPTURE_FRAME_GET_NUM,
    VIDEO_ECO_OCOPY_CAPTURE_START_NUM,
    VIDEO_ECO_OCOPY_CAPTURE_STOP_NUM,
    VIDEO_ECO_OCOPY_CAPTURE_CLOSE_NUM,

    // 16 Channel Audio
    AUDIO_CAPTURE_FRAME_16CH_NUM,
    
    // SDI signal
    GET_SDI_LINK_STATUS_NUM = 0xa0,
    GET_SDI_QUAD_LINK_MANUAL_MODE_NUM,
    SET_SDI_QUAD_LINK_MANUAL_MODE_NUM,
};
...
typedef struct _MWCAP_SDI_ANC_PACKETS_PAR {
    int                     count; // max: MWCAP_MAX_ANC_PACKETS_PER_FRAME
    MWCAP_PTR               packets; /* (MWCAP_SDI_ANC_PACKET, packets) */
} MWCAP_SDI_ANC_PACKETS_PAR;
...
// SDI ANC Packet
#define MWCAP_IOCTL_SET_SDI_ANC_TYPE                       _IOW ('X', SET_SDI_ANC_TYPE_NUM, MWCAP_SDI_ANC_TYPE)
#define MWCAP_IOCTL_GET_SDI_ANC_PACKET                     _IOR ('X', GET_SDI_ANC_PACKET_NUM, MWCAP_SDI_ANC_PACKET)
 ...
 */
#define MWCAP_IOCTL_GET_V4L2_FRAME_SDI_ANC_PACKETS         _IOWR('X', GET_V4L2_FRAME_SDI_ANC_PACKETS_NUM, MWCAP_SDI_ANC_PACKETS_PAR)
#define MWCAP_IOCTL_GET_ENABLE_V4L2_FRAME_SDI_ANC          _IOR ('X', GET_ENABLE_V4L2_FRAME_SDI_ANC_NUM, BOOLEAN)
#define MWCAP_IOCTL_SET_ENABLE_V4L2_FRAME_SDI_ANC          _IOW ('X', SET_ENABLE_V4L2_FRAME_SDI_ANC_NUM, BOOLEAN)
...
/* Only support MWCAP_VIDEO_DEINTERLACE_WEAVE and MWCAP_VIDEO_DEINTERLACE_BLEND */
#define MWCAP_IOCTL_VIDEO_ECO_GET_V4L2_DEI_MODE            _IOR ('X', VIDEO_ECO_GET_V4L2_DEI_MODE_NUM, int)
#define MWCAP_IOCTL_VIDEO_ECO_SET_V4L2_DEI_MODE            _IOW ('X', VIDEO_ECO_SET_V4L2_DEI_MODE_NUM, int)

#define MWCAP_IOCTL_VIDEO_ECO_OCOPY_CAPTURE_OPEN           _IOW ('X', VIDEO_ECO_OCOPY_CAPTURE_OPEN_NUM, MWCAP_VIDEO_ECO_OCOPY_CAPTURE_OPEN)
#define MWCAP_IOCTL_VIDEO_ECO_OCOPY_CAPTURE_FRAME_PUT      _IOW ('X', VIDEO_ECO_OCOPY_CAPTURE_FRAME_PUT_NUM, MWCAP_VIDEO_ECO_OCOPY_CAPTURE_FRAME)
#define MWCAP_IOCTL_VIDEO_ECO_OCOPY_CAPTURE_FRAME_GET      _IOR ('X', VIDEO_ECO_OCOPY_CAPTURE_FRAME_GET_NUM, MWCAP_VIDEO_ECO_OCOPY_CAPTURE_FRAME)
#define MWCAP_IOCTL_VIDEO_ECO_OCOPY_CAPTURE_START          _IO  ('X', VIDEO_ECO_OCOPY_CAPTURE_START_NUM)
#define MWCAP_IOCTL_VIDEO_ECO_OCOPY_CAPTURE_STOP           _IO  ('X', VIDEO_ECO_OCOPY_CAPTURE_STOP_NUM)
#define MWCAP_IOCTL_VIDEO_ECO_OCOPY_CAPTURE_CLOSE          _IO  ('X', VIDEO_ECO_OCOPY_CAPTURE_CLOSE_NUM)

#define MWCAP_IOCTL_AUDIO_CAPTURE_FRAME_16CH               _IOR ('X', AUDIO_CAPTURE_FRAME_16CH_NUM, MWCAP_AUDIO_CAPTURE_FRAME_16CH)

// SDI signal
#define MWCAP_IOCTL_GET_SDI_LINK_STATUS                    _IOWR('X', GET_SDI_LINK_STATUS_NUM, MWCAP_SDI_SINGLE_LINK_STATUS)
#define MWCAP_IOCTL_GET_SDI_QUAD_LINK_MANUAL_MODE           _IOR ('X', GET_SDI_QUAD_LINK_MANUAL_MODE_NUM, int)
#define MWCAP_IOCTL_SET_SDI_QUAD_LINK_MANUAL_MODE           _IOW ('X', SET_SDI_QUAD_LINK_MANUAL_MODE_NUM, int)
